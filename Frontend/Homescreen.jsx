    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.cardContainer}>
                <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Record')} activeOpacity={0.8}>
                    <Ionicons name="mic-outline" size={28} color="white" />
                    <Text style={styles.cardText}>Start New Session</Text>
                </TouchableOpacity>


                <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Notes')} activeOpacity={0.8}>
                    <MaterialIcons name="note-add" size={28} color="white" />
                    <Text style={styles.cardText}>Notes</Text>
                </TouchableOpacity>


                <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Quizzes')} activeOpacity={0.8}>
